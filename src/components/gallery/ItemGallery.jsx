    ...
    <>
      ...
      <div className="bg-secondary px-[5vw] sm:px-[2.5vw] relative">
        ...
        <div className="sm:flex py-[5vw] sm:py-[6vw]">
          <div className="sidebar w-[90vw] sm:w-[12rem] sm:border-r-2 border-buttonSecondary fixed sm:h-[80%] mt-4 sm:mt-0 flex flex-col items-center sm:items-start z-20">
